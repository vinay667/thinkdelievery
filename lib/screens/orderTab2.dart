...
import 'order_detail_deilvered_screen.dart';

class OrderTab2 extends StatefulWidget {
  OrderTab2State createState() => OrderTab2State();
}

class OrderTab2State extends State<OrderTab2> {
  ...
  Future<OrdersData> sendOrdersDataRequest(int page) async {
    try {
      String url = Uri.encodeFull(
          AppConstant.appBaseURL+'orderslist?page=$page');
      print(url);
      http.Response response = await http.post(url,body:jsonEncode(formdata),headers: {
  ...
  Widget listItemBuilder(value, int index) {
    return GestureDetector(
      onTap: (){
       // Navigator.push(context, MaterialPageRoute(builder: (context)=>OrderDetailScreen(value['id'])));
        Navigator.push(context, MaterialPageRoute(builder: (context)=>OrderDetailDelivered('Completed',value['id'])));
      },
      child: Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child:  Text(
                                value['s_address']!=null?value['s_address']:'NA',
                                style: TextStyle(
                                    fontSize: 12,
                                    fontFamily: 'OpenSans',
                                    fontWeight: FontWeight.w600,
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                SizedBox(width: 5),
                                Text(value['estimated_del_date']!=null?
                                getFormatDate(value['estimated_del_date']):'NA',
                                  style: TextStyle(
                                      fontSize: 11,
                                      fontFamily: 'OpenSans',
                                      fontWeight: FontWeight.w600,
